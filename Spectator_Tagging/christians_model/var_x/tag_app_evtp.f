...
C     Create 3 different output files for the 3 different values used of F2N
      ...
      OPEN(101, FILE = 'EVTP1.OUT', STATUS = 'REPLACE')
      OPEN(102, FILE = 'EVTP2.OUT', STATUS = 'REPLACE')
      OPEN(103, FILE = 'EVTP3.OUT', STATUS = 'REPLACE')
      OPEN(104, FILE = 'EVTP4.OUT', STATUS = 'REPLACE')
      OPEN(105, FILE = 'EVTP5.OUT', STATUS = 'REPLACE')
      OPEN(106, FILE = 'EVTP6.OUT', STATUS = 'REPLACE')
      OPEN(107, FILE = 'EVTP7.OUT', STATUS = 'REPLACE')
      OPEN(108, FILE = 'EVTP8.OUT', STATUS = 'REPLACE')
      OPEN(109, FILE = 'EVTP9.OUT', STATUS = 'REPLACE')
      REWIND(1)
C
...
C        PRINT 90000,    TP, PR2, PTR, FSIG, UNUM, F2/SPOL
             WRITE(I+100, 90000) TP, PR2, PTR, FSIG, UNUM, F2/SPOL
