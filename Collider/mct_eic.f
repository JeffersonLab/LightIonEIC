...
c$$$     &        100,0.0,2.0,100,1.0,15.0,0.)
         ...
         DO il=1,5
            DO jl=1,9
               ...
               DO kl=1,19
               call hbook1(90000+1000*il+100*jl+kl,'crs si',
c     &                 100,0.0,1.e1,0.)
     &                  100,-3.2,3.2,0.)
...
c     fac1 = (4*pi*alpha_em**2)/(x*q2**2)
c     fac2 = (1-yy-((x**2)*(yy**2)*(mneut**2))/q2)
c     fac = fac1*fac2
c     spect = tprime_KJ**2/(E_r*ResPot*xnn)
c     crs1 = si/fac
c     crs  = si*spect/fac
