...
int mainx(){
	...
	for (int iEvt=0; iEvt<NEvts; iEvt++) {
		...
		//		if(invts.alphaS>0.97&&invts.alphaS<1.03){
		    ...
		    //OUT << setiosflags(ios::left)  << setiosflags(ios::fixed) << setprecision(4) << scientific << alpha_r << " vs " << invts.alphaS << endl;
	...
	//  OUT << setiosflags(ios::left) << setiosflags(ios::fixed) << setprecision(3) << "\t" << "1" << " \t " << dum_particle_id << " \t " << "0" <<  " \t "<< scientific << pXx_Res << " \t " << pXy_Res << " \t " << pXz_Res << " \t " << EXE_Res << " \t " << dummass << " \t " << vXx_Res  << " \t " << vXy_Res << " \t " << vXz_Res << endl; 
       ...
       OUT << setiosflags(ios::left) << setiosflags(ios::fixed) << setprecision(3) << "\t" << "1" << " \t " << e_particle_id << " \t " << "0" <<  " \t "<< scientific <<pex_Lab << " \t " << pey_Lab << " \t " << pez_Lab << " \t " << EeE_Lab << " \t " << emass << " \t " << vex_Lab  << " \t " << vey_Lab << " \t " << vez_Lab << endl; 
       OUT << setiosflags(ios::left) << setiosflags(ios::fixed) << setprecision(3) << "\t" << "1" << " \t " << sp_particle_id << " \t " << "0" <<  " \t "<< scientific<< psx_Lab << " \t " << psy_Lab << " \t " << psz_Lab << " \t " << EsE_Lab << " \t " << spmass << " \t " << vsx_Lab  << " \t " << vsy_Lab << " \t " << vsz_Lab << endl; 
       OUT << setiosflags(ios::left) << setiosflags(ios::fixed) << setprecision(3) << "\t" << "1" << " \t " << dum_particle_id << " \t " << "0" <<  " \t "<< scientific << pXx_Lab << " \t " << pXy_Lab << " \t " << pXz_Lab << " \t " << EXE_Lab << " \t " << dummass << " \t " << vXx_Lab  << " \t " << vXy_Lab << " \t " << vXz_Lab << endl; 
