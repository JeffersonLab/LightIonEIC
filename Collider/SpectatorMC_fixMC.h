...
// const double Q2Max= 10.0;

// generated events in very specific kinematic region
const double xMin = 0.4;
const double xMax = 0.8;
const double Q2Min= 2.0;
const double Q2Max= 3.0;
...
//const double CrossingTheta = 0.0; // 0.010 for eRHIC/ePHENIX
