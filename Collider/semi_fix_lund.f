      program  semi_fix_lund
c     cross-section weighting process for fix-target frame
c   test version-1.0
...
c  fsgen 100K event generated.....fora moment
     ...
     &       ACTION='READ')
         ...
         DO ll=1,99999
          read (99,*) h1,h(1),h(2),h(3),h(4),h(5),h(6),h(7)
...
c$$$        xinv_pRT    = hvec0(6) 
c$$$
c$$$        call edenx(xinv_se,xinv_sq,xinv_q2,q0,ktr,xinv_alpha,xinv_pRT,
c$$$     & x,s,si,Fd_L,Fd_T,Fd_TL,Fd_TT,f2d,f1eff,f2eff,sun,icase,lc,lbj)
...
c        print *,si,crs,crs1
        ...
        if(sqrt(se).gt.0.0)then
           if(si.gt.0.and.xmx2.gt.0.and.tprime_KJ.gt.0)then
...
c              write(iu,10) xinv_xbj,xinv_q2,xinv_p_RT,xinv_alpha,
              write(iu,10) x,q2,p_rt,alpha_r,
     &             si,p_x2,e_x,xmx2,wn,
...
c$$$        xinv_pRT    = hvec0(6) 
c$$$c$$$
c$$$              write(iu,10) x,xinv_q2,xinv_pRT,xinv_alpha,
c$$$     &             si,p_x2,e_x,xmx2,wn,
c$$$     &             tprime_KJ,t_chn_MK,theta_qp,crs1,crs,
c$$$     &             p_rx,p_ry,p_rz,yy
